...
if ( class_exists( 'Tailor_Element' ) && ! class_exists( 'Tailor_Youtube_Embed_Element' ) ) {

	class Tailor_Youtube_Embed_Element extends Tailor_Element {
	    /**
	    ...
	    protected function register_controls() {
		    ...
		    $this->add_setting( 'youtube_id', array(
			    'sanitize_callback'     =>  'tailor_sanitize_text',
			    'default'               =>  'Srmdij0CU1U',
		    ) );
		    $this->add_control( 'youtube_id', array(
		    ...
		    $this->add_control( 'width', array(
			    'label'                 =>  __( 'YouTube video width', '' ),
			    'type'                  =>  'text',
			    'section'               =>  'general',
			    'priority'              =>  $priority = 20,
		    ) );

		    $this->add_setting( 'height', array(
			    'sanitize_callback'     =>  'tailor_sanitize_text',
			    'default'               =>  '315',
		    ) );
		    $this->add_control( 'height', array(
			    'label'                 =>  __( 'YouTube video height', '' ),
			    'type'                  =>  'text',
			    'section'               =>  'general',
